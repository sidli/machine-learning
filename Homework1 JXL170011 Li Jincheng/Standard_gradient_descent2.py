...
def init_data():
    ...
    for line in list(map(lambda x:x.strip(),open("mystery.data").readlines())):
...
def Calculate_a_b(x,y,aT,b,step_size):
    ...
    aT[2] = aT[2] - step_size * sumOfDeriv_aT[2]
    aT[3] = aT[3] - step_size * sumOfDeriv_aT[3]
    b = b - (step_size * sumOfDeriv_b)
    return aT, b, sumOfDeriv_aT[0] * sumOfDeriv_aT[1] * sumOfDeriv_aT[2] * sumOfDeriv_aT[3], sumOfDeriv_b
